...
0000000080200092 <strnlen>:
    80200092:	872a                	mv	a4,a0
    80200094:	4501                	li	a0,0
    80200096:	e589                	bnez	a1,802000a0 <strnlen+0xe>
    80200098:	a811                	j	802000ac <strnlen+0x1a>
    8020009a:	0505                	addi	a0,a0,1
    8020009c:	00a58763          	beq	a1,a0,802000aa <strnlen+0x18>
    802000a0:	00a707b3          	add	a5,a4,a0
    802000a4:	0007c783          	lbu	a5,0(a5)
    802000a8:	fbed                	bnez	a5,8020009a <strnlen+0x8>
    802000aa:	8082                	ret
    802000ac:	8082                	ret
...
00000000802000c0 <printnum>:
    ...
    802000fa:	020a5a13          	srli	s4,s4,0x20
    802000fe:	00000797          	auipc	a5,0x0
    80200102:	3f278793          	addi	a5,a5,1010 # 802004f0 <sbi_console_putchar+0x42>
    80200106:	7402                	ld	s0,32(sp)
    80200108:	9a3e                	add	s4,s4,a5
...
000000008020012c <vprintfmt>:
    ...
    8020019c:	0ff5f593          	andi	a1,a1,255
    ...
    802001e0:	0ff5f593          	andi	a1,a1,255
